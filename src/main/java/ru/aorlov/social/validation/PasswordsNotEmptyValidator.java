...
public class PasswordsNotEmptyValidator implements ConstraintValidator<PasswordsNotEmpty, Object> {
    ...
    public boolean isValid(Object value, ConstraintValidatorContext context) {
        ...
        try {
            ...
            throw new RuntimeException("NoSuchField. Exception occurred during validation", ex);

        } catch (IllegalAccessException ex) {
            throw new RuntimeException("IllegalAccess. Exception occurred during validation", ex);
        }
