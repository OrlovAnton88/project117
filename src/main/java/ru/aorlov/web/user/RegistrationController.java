...
import ru.aorlov.security.util.SecurityUtil;
...
import ru.aorlov.social.service.DuplicateEmailException;
import ru.aorlov.social.service.UserService;
...
public class RegistrationController {
    ...
    public String registerUserAccount(@Valid @ModelAttribute("user") RegistrationForm userAccountData,
        ...
        UserAccount registered = createUserAccount(userAccountData, result);
