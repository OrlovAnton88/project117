        ...
        <table class="table col-md-12">
            ...
            <c:forEach items="${materials}" var="material" varStatus="status">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/material/edit/<c:out value="${material.meterialId}"/>"><spring:message
                                code="material.edit.link.label"/></a>
                        todo
                    </td>
                    <td>
                        todo
                        <a href="${pageContext.request.contextPath}/material/delete/<c:out value="${material.meterialId}"/>"><spring:message
                                code="material.delete.link.label"/></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
